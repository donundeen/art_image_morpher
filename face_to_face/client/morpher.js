...
(function() {
  ...
  MorpherJS.Matrix = (function() {
    ...
    function Matrix() {
      this.multiplyWith = bind(this.multiplyWith, this);
      this.toTransform = bind(this.toTransform, this);
      this.toCSS = bind(this.toCSS, this);
      this.apply = bind(this.apply, this);
      this.removeTransform = bind(this.removeTransform, this);
      this.shear = bind(this.shear, this);
  ...
  MorpherJS.Image = (function(superClass) {
    ...
    function Image(json) {
      ...
      this.refreshSource = bind(this.refreshSource, this);
      this.draw = bind(this.draw, this);
      this.propagateMeshEvent = bind(this.propagateMeshEvent, this);
      this.removeTriangle = bind(this.removeTriangle, this);
      this.addTriangle = bind(this.addTriangle, this);
      this.splitEdge = bind(this.splitEdge, this);
      this.getRelativePositionOf = bind(this.getRelativePositionOf, this);
      this.makeCompatibleWith = bind(this.makeCompatibleWith, this);
      this.removePoint = bind(this.removePoint, this);
      this.addPoint = bind(this.addPoint, this);
      this.setMaxSize = bind(this.setMaxSize, this);
      ...
      this.getWeight = bind(this.getWeight, this);
      this.setWeight = bind(this.setWeight, this);
      this.setSrc = bind(this.setSrc, this);
    ...
    Image.prototype.propagateMeshEvent = function() {
      ...
      type = arguments[0], target = arguments[1], args = 3 <= arguments.length ? slice.call(arguments, 2) : [];
      return this.trigger.apply(this, [type, this].concat(args));
    };

    Image.prototype.draw = function(ctx, mesh) {
      var i, l, len, ref, results, triangle;
      ref = this.triangles;
      results = [];
      for (i = l = 0, len = ref.length; l < len; i = ++l) {
        triangle = ref[i];
        results.push(triangle.draw(this.source, ctx, mesh.triangles[i]));
      }
      return results;
    };
  ...
  MorpherJS.Mesh = (function(superClass) {
    ...
    function Mesh(params) {
      ...
      this.addTriangle = bind(this.addTriangle, this);
      this.splitEdge = bind(this.splitEdge, this);
      this.findNearestPointOfLine = bind(this.findNearestPointOfLine, this);
      this.findLine = bind(this.findLine, this);
      this.resolveRelativePosition = bind(this.resolveRelativePosition, this);
      this.getRelativePositionOf = bind(this.getRelativePositionOf, this);
      this.changeHandler = bind(this.changeHandler, this);
      this.makeCompatibleWith = bind(this.makeCompatibleWith, this);
      this.removePoint = bind(this.removePoint, this);
      this.addPoint = bind(this.addPoint, this);
      this.refreshBounds = bind(this.refreshBounds, this);
      this.setMaxSize = bind(this.setMaxSize, this);
      this.points = [];
      this.triangles = [];
    }
    ...
    Mesh.prototype.makeCompatibleWith = function(mesh) {
      ...
      if (this.points.length !== mesh.points.length) {
        if (this.points.length > mesh.points.length) {
          ...
          ref = mesh.points.slice(this.points.length, +mesh.points.length + 1 || 9e9);
          results = [];
          for (l = 0, len = ref.length; l < len; l++) {
            point = ref[l];
            results.push(this.addPoint({
              x: point.x,
              y: point.y
            }));
          }
    ...
    Mesh.prototype.getRelativePositionOf = function(point) {
      var a, a2, b, b2, baseD, d, dX, dY, directionX, directionY, i, iX, iY, intersection, l, len, len1, m, n, nearest, obj, p, ref, ref1, ref2, x, y;
      nearest = [];
      ref = this.points;
      for (l = 0, len = ref.length; l < len; l++) {
        p = ref[l];
        if (p !== point) {
          ...
          if (nearest.length === 0) {
            ...
            for (i = m = 0, len1 = nearest.length; m < len1; i = ++m) {
              n = nearest[i];
      ...
      switch (nearest.length) {
        ...
        case 2:
        case 3:
          ref1 = this.findLine(nearest[0].point, nearest[1].point), a = ref1[0], b = ref1[1];
          if (nearest.length === 2) {
            intersection = this.findNearestPointOfLine(a, b, point);
          } else {
            ref2 = this.findLine(point, nearest[2].point), a2 = ref2[0], b2 = ref2[1];
            iX = (b2 - b) / (a - a2);
            iY = a * iX + b;
      ...
      nearest = (function() {
        var len2, o, results;
        results = [];
        for (o = 0, len2 = nearest.length; o < len2; o++) {
          n = nearest[o];
          results.push(this.points.indexOf(n.point));
        }
        return results;
      }).call(this);
      return {
    ...
    Mesh.prototype.splitEdge = function(p1, p2) {
      var i, i1, i2, i3, i4, l, len, p3, p4, point, ref, results, triangle;
      ...
      while (i < this.triangles.length) {
        ...
        if (triangle.hasPoint(p1) && triangle.hasPoint(p2)) {
          ref = [triangle.p1, triangle.p2, triangle.p3];
          for (l = 0, len = ref.length; l < len; l++) {
            point = ref[l];
          ...
          results.push(this.addTriangle(i2, i3, i4));
        } else {
          results.push(i++);
        }
      }
      ...
      if (json.points != null) {
        ...
        for (i = l = 0, len = ref.length; l < len; i = ++l) {
          ...
          if (i > this.points.length - 1) {
            results.push(this.addPoint(point, params));
          } else {
            results.push(this.points[i].fromJSON(point, params));
          }
        }
        return results;
      }
    ...
    Mesh.prototype.reset = function() {
      ...
      for (l = 0, len = ref.length; l < len; l++) {
        point = ref[l];
        results.push(this.removePoint(point));
      }
      return results;
    };
    ...
    Mesh.prototype.remove = function() {
      ...
      while (t = this.triangles[0]) {
        results.push(this.removeTriangle(t, {
          silent: true
        }));
      }
      return results;
  ...
  MorpherJS.Morpher = (function(superClass) {
    extend(Morpher, superClass);
    ...
    function Morpher(params) {
      ...
      this.updateMesh = bind(this.updateMesh, this);
      this.refreshMaxSize = bind(this.refreshMaxSize, this);
      this.updateCanvasSize = bind(this.updateCanvasSize, this);
      this.drawNow = bind(this.drawNow, this);
      this.draw = bind(this.draw, this);
      this.removeTriangleHandler = bind(this.removeTriangleHandler, this);
      this.addTriangleHandler = bind(this.addTriangleHandler, this);
      this.triangleExists = bind(this.triangleExists, this);
      this.addTriangle = bind(this.addTriangle, this);
      this.removePointHandler = bind(this.removePointHandler, this);
      this.addPointHandler = bind(this.addPointHandler, this);
      this.addPoint = bind(this.addPoint, this);
      this.changeHandler = bind(this.changeHandler, this);
      this.loadHandler = bind(this.loadHandler, this);
    ...
    Morpher.prototype.set = function(weights, params) {
      ...
      for (i = l = 0, len = ref.length; l < len; i = ++l) {
        ...
        w = weights[i] || 0;
        this.state.push(w);
        results.push(img.setWeight(w, params));
      }
      return results;
    };
    ...
    Morpher.prototype.addPoint = function(x, y) {
      var image, l, len, ref;
      ref = this.images.concat(this.mesh);
      for (l = 0, len = ref.length; l < len; l++) {
        image = ref[l];
        image.addPoint({
          x: x,
    ...
    Morpher.prototype.removePointHandler = function(image, point, index) {
      var img, k, l, len, len1, len2, m, o, ref, ref1, triangle, v;
      ref = this.images;
      for (l = 0, len = ref.length; l < len; l++) {
        img = ref[l];
        if (img.points.length > image.points.length) {
      ...
      for (m = 0, len1 = ref1.length; m < len1; m++) {
        triangle = ref1[m];
        for (k = o = 0, len2 = triangle.length; o < len2; k = ++o) {
          v = triangle[k];
          if (v >= index) {
            triangle[k] -= 1;
          }
    ...
    Morpher.prototype.drawNow = function() {
      var blend, image, l, len, sortedImages;
      ...
      if (this.canvas.width > 0 && this.canvas.height > 0) {
        ...
        for (l = 0, len = sortedImages.length; l < len; l++) {
          image = sortedImages[l];
    ...
    Morpher.prototype.refreshMaxSize = function() {
      var img, l, len, ref, results;
      ref = this.images;
      results = [];
      for (l = 0, len = ref.length; l < len; l++) {
        img = ref[l];
        results.push(img.setMaxSize(this.canvas.width, this.canvas.height));
      }
      return results;
    };

    Morpher.prototype.updateMesh = function() {
      var i, img, l, len, p, ref, results, x0, y0;
      x0 = this.canvas.width / 2;
      y0 = this.canvas.height / 2;
      ref = this.mesh.points;
      results = [];
      for (i = l = 0, len = ref.length; l < len; i = ++l) {
        p = ref[i];
        p.x = x0;
        ...
        results.push((function() {
          ...
          for (m = 0, len1 = ref1.length; m < len1; m++) {
            ...
            results1.push(p.y += (img.getY() + img.points[i].y - y0) * img.weight);
          }
          return results1;
        }).call(this));
      }
    ...
    Morpher.prototype.animationStep = function() {
      var i, l, len, progress, ref, state, t, w;
      if (this.t0 != null) {
    ...
    Morpher.defaultBlendFunction = function(destination, source, weight) {
      var dData, i, l, len, ref, sData, value;
    ...
    Morpher.prototype.fromJSON = function(json, params) {
      var i, image, l, len, len1, m, ref, ref1, results, triangle;
      if (json == null) {
        json = {};
      }
      if (params == null) {
      ...
      if (json.triangles != null) {
        ref1 = json.triangles.slice(this.triangles.length);
        results = [];
        for (m = 0, len1 = ref1.length; m < len1; m++) {
          triangle = ref1[m];
          results.push(this.addTriangle(triangle[0], triangle[1], triangle[2]));
        }
        return results;
      }
    };
  ...
  MorpherJS.Point = (function(superClass) {
    ...
    function Point(x, y, params) {
      ...
      this.distanceTo = bind(this.distanceTo, this);
  ...
  MorpherJS.Triangle = (function(superClass) {
    ...
    function Triangle(p1, p2, p3) {
      ...
      this.draw = bind(this.draw, this);
      this.visualize = bind(this.visualize, this);
      this.getHeight = bind(this.getHeight, this);
      this.getBounds = bind(this.getBounds, this);
      this.transform = bind(this.transform, this);
      this.clone = bind(this.clone, this);
      this.hasPoint = bind(this.hasPoint, this);
      this.remove = bind(this.remove, this);
      this.p1 = p1;
      this.p2 = p2;
      this.p3 = p3;
    ...
    Triangle.prototype.getBounds = function() {
      var bottom, l, left, len, p, ref, right, top;
    ...
    Triangle.prototype.draw = function(sourceBitmap, destinationCtx, destinationTriangle) {
      var bottom, from, height, l, left, len, matr1, matr2, point, points, ref, ref1, right, rotation2, scaleX, scaleY, state2, state3, to, top, width;
      ref = this.getBounds(), left = ref[0], top = ref[1], right = ref[2], bottom = ref[3];
      width = right - left;
      height = bottom - top;
